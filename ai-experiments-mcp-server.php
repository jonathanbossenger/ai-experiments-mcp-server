				...
				'properties' => array(
					...
					'plugins' => array(
						...
						'items' => array(
							'type' => 'object',
							'properties' => array(
								'name' => array('type' => 'string', 'description' => __('Plugin name.', 'ai-experiments-mcp-server')),
								'slug' => array('type' => 'string', 'description' => __('Plugin slug/directory.', 'ai-experiments-mcp-server')),
								'file' => array('type' => 'string', 'description' => __('Main plugin file path.', 'ai-experiments-mcp-server')),
								'status' => array('type' => 'string', 'description' => __('Plugin status (active/inactive).', 'ai-experiments-mcp-server')),
								'version' => array('type' => 'string', 'description' => __('Plugin version.', 'ai-experiments-mcp-server')),
							),
						),
					),
					'error' => array(
